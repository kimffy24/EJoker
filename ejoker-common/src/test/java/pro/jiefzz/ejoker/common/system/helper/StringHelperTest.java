	...
	public void formatTest() {
		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, r1_1);
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, r1_1, r1_2);
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, r1_1, r1_2, r1_3);
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, "TEST", "jiefzz", "java", 512);
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, "TEST", "jiefzz", "java", 512, 4096, 16384, "你好", "世界");
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, "jiefzz", "java", 5354);
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, "jiefzz", "java", 1234, 2345, 3456, 4567, 5678, 6789, 7890, 1, 2, 3, 4, 5, 6, 7);
...

		{
			Assertions.assertThrows(RuntimeException.class, () -> {
				String r1_tpl = "Hello {, welcome to the {} world.";
				StringUtilx.fmt(r1_tpl, "jiefzz", "java");
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, null, null);
...

		{
			...
			String r1Result = StringUtilx.fmt(r1_tpl, nullValue);
...

		{
			String r1_tpl = "null is {}.";
			String r1Expected = "null is .";
			String r1Result = StringUtilx.fmt(r1_tpl, null);
