 ...
 */
@EService
public class DefaultProcessingPublishableExceptionMessageHandler extends DefaultProcessingMessageHandlerAbstract<ProcessingPublishableExceptionMessage, IPublishableException> {
